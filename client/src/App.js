          ...
          <BrowserRouter basename='/'>
            ...
            <nav className='navbar navbar-expand-sm header navbar-light bg-light'>
              <Link  to="/" className="appLink mx-auto navbar-brand resp1" href="#">
                ...
                <h3 style={{color:"#3C6E71"}}>BOSS TAILOR</h3>
              </Link>
              ...
              <ul className="navbar-nav headerTextLinks mr-auto">
                  ...
                  <Link to="/mission" className='appLink LinkText' style={{marginLeft:"30px", fontSize:"15px",fontWeight:"600", color:"#284B63"}}>Our Mission</Link>
                  </li>
                  <li className="nav-item headerTextItem mx-2">
                  <Link to="/products" className='appLink LinkText 'style={{marginLeft:"20px", fontSize:"15px",fontWeight:"600", color:"#284B63"}}>Products</Link>
                  </li>
                  {/* <li className="nav-item headerTextItem mx-2">
